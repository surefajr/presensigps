...
class CutiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return Redirect::back()->with(['warning'=>'Data Cuti Gagal Di Simpan'. $e->getMessage()]);
        }
    }
    ...
    public function update(Request $request,$kode_cuti)
    {
        ...
        try {
            DB::table('master_cuti')->where('kode_cuti',$kode_cuti)->update(['nama_cuti'=>$nama_cuti,'jml_hari'=>$jml_hari]);
            return Redirect::back()->with(['success'=>'Data Cuti Berhasil Di Update']);
        } catch (\Throwable $th) {
            return Redirect::back()->with(['warning'=>'Data Cuti Gagal Di Update'.$e->getMessage()]);
        }
    }
    ...
    public function delete($kode_cuti)
    {
        try {
            ...
            return Redirect::back()->with(['warning'=>'Data Cuti Gagal Di Hapus'.$e->getMessage()]);
        }
    }
}
