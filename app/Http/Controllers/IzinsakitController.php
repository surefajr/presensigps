...
class IzinsakitController extends Controller
{
    ...
    $kode_izin = buatkode($lastkodeizin,$format,3);
       ...
       if($cekpresensi ->count() > 0){
        ...
        if($simpan){
            ...
            return redirect('/presensi/izin')->with(['success'=>'Data Izin Sakit Berhasil di simpan']);
        }else{
            return redirect('/presensi/izin')->with(['error'=>'Data Izin Sakit Gagal di simpan']);
        }
    }
    }
    ...
    public function update($kode_izin,Request $request)
    {
        ...
        try {
            ...
            return redirect('/presensi/izin')->with(['success'=>'Data Izin Sakit Berhasil di Update']);
        } catch (\Exception $e) {
            return redirect('/presensi/izin')->with(['error'=>'Data Izin Sakit Gagal di Update']);
        }
