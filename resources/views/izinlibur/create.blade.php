...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Form Izin LIBUR</div>
        <div class="right"></div>
    </div>
@endsection
...
@section('content')
    <div class="row" style="margin-top:70px">
        <div class="col">
            <form method="POST" action="/izinlibur/store" id="frmizin">
                @csrf
                ...
                <div class="form-group">
                    <input name="keterangan" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan"
                        autocomplete="off">
                </div>
                <div class="form-group">
